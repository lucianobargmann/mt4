...
void ReopenLastClosedOrder()
{
  ...
  for (i = 0; i < hstTotal; i++)
  {
    ...
    if (OrderMagicNumber() != MagicNumber || OrderSymbol() != Symbol() || OrderType() == OP_SELLLIMIT || OrderType() == OP_SELLSTOP)
      continue;
...
void FindClosedOrderEx()
{
  ...
  if (count > closedOrdersCount)
  {
    ...
    if (OrderMagicNumber() != MagicNumber || OrderSymbol() != Symbol() || OrderType() == OP_SELLLIMIT || OrderType() == OP_SELLSTOP) return;
...
int ReopenClosedOrder(int ticket)
{
  ...
  if (OrderSelect(ticket, SELECT_BY_TICKET) == true)
  {
    ...
    for (int i = 0; i < total; i++)
    {
      ...
      if (OrderMagicNumber() != MagicNumber || OrderSymbol() != Symbol())
        continue;
      if (OrderOpenPrice() == lastprice || OrderType() == OP_SELLLIMIT || OrderType() == OP_SELLSTOP)
      {
